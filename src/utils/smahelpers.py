...
TRIPOWER_PARAM_DICT = {
    ...
    "Metering.TotWhOut": ("AC Side", "Total yield", "Wh"),
    "Metering.TotWhOut.Pv": ("AC Side", "Total yield", "Wh"),
    ...
    "Operation.VArCtl.VArModStt": (
        "System and device control",
        "Active reactive power behavior",
        "",
    ),
    "Operation.WMaxLimSrc": (
        "System and device control",
        "Source of maximum active power setpoint",
        "",
    ),
    "Operation.WMinLimSrc": (
        "System and device control",
        "Source of minimum active power setpoint",
        "",
    ),
    ...
    "Setpoint.PlantControl.Inverter.WModCfg.WCtlComCfg.W": (
        "System and device control",
        "Active power limitation by PV system control",
        "W",
    ),
