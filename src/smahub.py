...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-V", "--verboser", action="store_true", help="Enable even more verbose output"
    )
    parser.add_argument(
        "-d", "--debug", action="store_true", help="Enable debug server"
    )
    parser.add_argument(
        "-p", "--debug-port", action="store", help="Debug server port", default=5678
    )
    parser.add_argument(
        "-D",
        "--debug-hold",
